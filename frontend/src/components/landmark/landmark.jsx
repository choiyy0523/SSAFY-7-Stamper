...
export default function landmark() {
    ...
    let landmarkseq = useParams().landmarkNo;
    ...
    useEffect(() => {
        getBookDetail(userSeq, landmarkseq, (response)=>{
    ...
    function register(){
        ...
        if (val){
            ...
            let ubcImage = year+""+month+""+datenow+""+ hours +"" + minutes + "" + seconds + "" + milliseconds + "" + userSeq + "" + landmarkseq;
